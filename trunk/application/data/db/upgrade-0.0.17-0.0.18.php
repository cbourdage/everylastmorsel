...
CREATE TABLE  `crops_inventory_transaction` (
	`entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	`crop_id` int(10) unsigned NOT NULL,
	`user_id` int(10) unsigned NOT NULL,
	...
	`modified_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
	PRIMARY KEY  (`entity_id`),
	CONSTRAINT `fk_crops_inventory_trans_plot_crop_id` FOREIGN KEY (`crop_id`) REFERENCES `plot_crops` (`entity_id`) ON DELETE CASCADE,
	CONSTRAINT `fk_crops_inventory_trans_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
