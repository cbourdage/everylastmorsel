...
class Colony_Object implements ArrayAccess
{
    ...
    */
    ...
    public function getData($key='', $index=null)
    {
        ...
        if (strpos($key,'/')) {
            ...
            foreach ($keyArr as $i=>$k) {
                ...
                if (is_array($data)) {
                    ...
                    $data = $data[$k];
                } elseif ($data instanceof Colony_Object) {
                    $data = $data->getData($k);
                } else {
                    return $default;
                }
        ...
        if (isset($this->_data[$key])) {
            ...
            } elseif ($value instanceof Colony_Object) {
    ...
    public function __call($method, $args)
    {
        ...
        throw new Colony_Exception("Invalid method ".get_class($this)."::".$method."(".print_r($args,1).")");
    }
